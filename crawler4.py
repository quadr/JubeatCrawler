...
contestListUrl = 'http://p.eagate.573.jp/game/jubeat/prop/p/contest/join_info.html?s=1&rival_id=%d'
contestDataUrl = 'http://p.eagate.573.jp/game/jubeat/prop/p/contest/detail.html?contest_id=%d'
