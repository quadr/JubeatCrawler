...
playScoreUrl = 'http://p.eagate.573.jp/game/jubeat/qubell/p/playdata/music.html?rival_id=%d&sort=&page=%d'
musicPageUrl = 'http://p.eagate.573.jp/game/jubeat/qubell/p/playdata/music_detail.html?rival_id=%d&mid=%d'
playHistoryUrl = 'http://p.eagate.573.jp/game/jubeat/qubell/p/playdata/history.html?rival_id=%d'
contestListUrl = 'http://p.eagate.573.jp/game/jubeat/qubell/p/contest/join_info.html?s=1&rival_id=%d'
contestDataUrl = 'http://p.eagate.573.jp/game/jubeat/qubell/p/contest/detail.html?contest_id=%d'
playerInfoUrl = 'http://p.eagate.573.jp/game/jubeat/qubell/p/playdata/index_other.html?rival_id={0}'
