...
contestDataUrl = 'https://p.eagate.573.jp/game/jubeat/festo/contest/detail.html?contest_id=%d'
playerInfoUrl = 'https://p.eagate.573.jp/game/jubeat/festo/playdata/index_other.html?rival_id={0}'

def getRedis():
  return redis.Redis(db=7)
